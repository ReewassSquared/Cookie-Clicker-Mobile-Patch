G.addData(function(){
	...
	//====== Buildings ======
	//INFO(ReewassSquared): next available ID: 619.
...
//standard building upgrades
	...
	new G.Upgrade({
		...
		id:619,
		desc:`Unlocks a new tier of upgrades that affect <b>2 buildings at the same time</b>. Synergies appear once you have <b>15</b> of both buildings.`,
	...
	new G.Upgrade({
		...
		id:620,	
		desc:`Farms gain <b>+5% CpS</b> per time machine. Time machines gain <b>+0.1% CpS</b> per farm.`,
		q:`Lets you predict optimal planting times. It's crazy what time travel can do!`,
		icon:[2,20],
		order:620,
		pool:'synergiesOne',
		cost:2800000000000000000,
		unlockAt:{upgrades:['Synergies Vol. I'],buildings:[2,15,11,15]},
	});
	
	new G.Upgrade({
		name:`Seismic magic`,
		id:621,	
		desc:`Mines gain <b>+5% CpS</b> per wizard tower. Wizard towers gain <b>+0.1% CpS</b> per mine.`,
